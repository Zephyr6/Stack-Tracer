...
{
	public partial class XButton : PositionedObject, IDestroyable, IVisible, IWindow
	{
		...
		public float XBoxXButtonScaleX
		{
			get
			{
				return XBoxXButton.ScaleX;
			}
			set
			{
				XBoxXButton.ScaleX = value;
			}
		}
		public float XBoxXButtonScaleY
		{
			get
			{
				return XBoxXButton.ScaleY;
			}
			set
			{
				XBoxXButton.ScaleY = value;
			}
		}
        ...
        public XButton(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public XButton(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void PostInitialize ()
		{
			...
			if (XBoxXButton!= null && XBoxXButton.Parent == null)
			{
				XBoxXButton.CopyAbsoluteToRelative();
				XBoxXButton.AttachTo(this, false);
			}
			X = 0f;
			Y = 0f;
			XBoxXButtonScaleX = 0f;
			XBoxXButtonScaleY = 0f;
			RotationX = 0f;
			RotationY = 0f;
			RotationZ = 0f;
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (IsStaticContentLoaded == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("XButtonStaticUnload", UnloadStaticContent);
						mHasRegisteredUnload = true;
					}
				}
				bool registerUnload = false;
				if (!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/xbutton/xboxx.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
		...
		public static void UnloadStaticContent ()
		{
			...
			if (XboxX != null)
			{
				XboxX.RemoveFromManagers(ContentManagerName != "Global");
				XboxX= null;
			}
		}
    ...
    // DELEGATE START HERE
		...
		public virtual bool HasCursorOver (FlatRedBall.Gui.Cursor cursor)
		{
			...
			if (cursor.IsOn3D(XBoxXButton, LayerProvidedByContainer))
			{
				return true;
			}
			return false;
	...
	// Extra classes
	public static class XButtonExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<XButton> list, bool value)
		{
